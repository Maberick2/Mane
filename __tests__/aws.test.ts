...
describe('getRegistriesData', () => {  
  ...
  test('handles empty authorization data', async () => {  
    ...
    const regData = await aws.getRegistriesData('012345678901.dkr.ecr.eu-west-3.amazonaws.com');  
  ...
  test('handles missing authorization token', async () => {  
    mockEcrGetAuthToken.mockImplementation(() => {  
      return Promise.resolve({  
        authorizationData: [{  
          proxyEndpoint: 'https://012345678901.dkr.ecr.eu-west-3.amazonaws.com',  
